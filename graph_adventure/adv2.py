...
stack = Stack()
# class Queue(): # technically a stack
#     def __init__(self):
#         self.queue = []
...
while len(traversalGraph) < 500 and len(traversalPath) < 5000:
    ...
    # Go west, check CurrentRoom
        ...
        # backtrack = backtrack_list.dequeue() 
        backtrack = stack.pop()
